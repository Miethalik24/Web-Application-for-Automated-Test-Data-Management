...
## Test Automation Framework using Selenium Java and TestNG building by Miethali Kulkarni
...
- Setup **Allure ENV**:
  ...
  or
  https://miethali24.com/blog/selenium-java/selenium-java-tai-nguyen-cai-dat-moi-truong)
...
- The base value read from Enums (src/main/java/miethali24/com/enums)
...
- Config mail with email and password in **_src/main/java/miethali24/com/mail/EmailConfig.java_**
...
- Call class: LogUtils.info(), LogUtils.pass(), LogUtils.error(),... (**LogUtils** is a custom global class from Log4j2)
  (**_import utils.com.miethali24.LogUtils.java_**)
...
- Create function with annotation **DataProvider** on **src/test/java/miethali24/com/projects/website/crm/dataprovider/DataProviderManager.java**
- Read Excel file with Map and Hashtable

**9. Base function in the package**

- **_src/main/java/miethali24/com/utils_**
- **_src/main/java/miethali24/com/helpers_**
...
- All in one package: src/test/java/miethali24/com/projects/website/crm/testcases
...
- Setup in src/main/java/miethali24/com/report/TelegramManager.java
- Example: src/test/java/miethali24/com/projects/website/crm/testcases/TestSimpleCode.java
